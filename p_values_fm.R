...
statistic<-read.table("test_stats_fm.csv",header=TRUE, sep=",", dec=".") 
...
pvalueA=2*pt(-abs(A),127)#188)
pvalueU=2*pt(-abs(U),127)#188)
pvalueC=2*pt(-abs(C),127)#188)
pvalueG=2*pt(-abs(G),127)#188)                               
...
write.table(finalpvalue, file="pvalue_fm.csv",sep=",",row.names=F)
