...
statistic<-read.table("test_stats_seq.csv",header=TRUE, sep=",", dec=".") 
...
pvalueA=2*pt(-abs(A),318)#127)#188)
pvalueU=2*pt(-abs(U),318)#127)#188)
pvalueC=2*pt(-abs(C),318)#127)#188)
pvalueG=2*pt(-abs(G),318)#127)#188)                               
...
write.table(finalpvalue, file="pvalue_seq.csv",sep=",",row.names=F)
