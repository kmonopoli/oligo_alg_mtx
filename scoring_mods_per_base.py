...
input_data_file = 'csv_dbcomp/nonfm_luciferase_data_cleaned_TS_101317.csv'#'output_data_diana.csv'
...
wts = [q[1:13] for q in csv_io.CSV_Reader('output/weight_matrixes_for_paper/mod_weight_matrix_top90_bot150_luc_nonfm_sense.csv').file_data]
...
w = csv_io.CSV_Writer('mod_scores_per_base.csv',['iD','modScore'],data_ls,True)
w.write_to_file()
